...
// 勝ち上がりツリー（公式ブラケット）に沿った試合の表示順序。
// 上から SF-1 の山(QF-1, QF-2) → SF-2 の山(QF-3, QF-4) の順に並べる。
const R32_ORDER = [
  'R32-2', 'R32-5',   // M74 & M77 -> R16-1 ┐ QF-1
  'R32-1', 'R32-3',   // M73 & M75 -> R16-2 ┘
  'R32-11', 'R32-12', // M83 & M84 -> R16-5 ┐ QF-2
  'R32-9', 'R32-10',  // M81 & M82 -> R16-6 ┘
  'R32-4', 'R32-6',   // M76 & M78 -> R16-3 ┐ QF-3
  'R32-7', 'R32-8',   // M79 & M80 -> R16-4 ┘
  'R32-14', 'R32-16', // M86 & M88 -> R16-7 ┐ QF-4
  'R32-13', 'R32-15'  // M85 & M87 -> R16-8 ┘
];

const R16_ORDER = [
  'R16-1', 'R16-2',   // M89 & M90 -> QF-1
  'R16-5', 'R16-6',   // M93 & M94 -> QF-2
  'R16-3', 'R16-4',   // M91 & M92 -> QF-3
  'R16-7', 'R16-8'    // M95 & M96 -> QF-4
];

const QF_ORDER = [
  'QF-1', 'QF-2',     // M97 & M98 -> SF-1
  'QF-3', 'QF-4'      // M99 & M100 -> SF-2
];
